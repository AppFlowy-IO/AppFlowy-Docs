...
1. When we click the Heading item a Node of the corresonding type ('heading') gets inserted in the **Editor Document Tree** using the `EditorState`.
...
<figure><img src="../../../.gitbook/assets/image (31).png" alt=""><figcaption><p>the toolbar feature allows us to apply various styles to nodes in the editor.</figcaption></figure>
