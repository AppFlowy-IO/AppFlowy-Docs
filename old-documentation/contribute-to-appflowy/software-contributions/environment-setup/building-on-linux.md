...
{% hint style="info" %}
You should fork the code instead if you wish to submit code to AppFlowy. You will find information on that in [Setting Up Your Repositories](../../../../documentation/software-contributions/submitting-code/setting-up-your-repositories.md).
{% endhint %}
